let navigator = {
    ...
    "appCodeName": "Mozilla",
    "appName": "Netscape",
    "appVersion": "5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36",
    "platform": "Win32",
    "product": "Gecko",
...
let PublicKeyMo;
let PublicKeyEx = "10001";

app.post("/data", function (req, res) {
    var pass = "b" + req.body.password;
    var key = req.body.publickey;
    var eventID = req.body.eventid;
    PublicKeyMo = key;
    var EncryptPass = encryptData(eventID + "," + pass);
    res.end(EncryptPass);
});
